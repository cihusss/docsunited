...
<div class="grid">
	...
	<div class="row">
		<div class="col-1-2 min-height bg-grey-md pad-lg bb-bg bb-home02"></div>
		<div class="col-1-2 min-height pad-lg col-flex-column bb-bg bb-logo-right">
			<h2>Why Docs United?</h2>
			<ul>
	...
	<div class="row">
		<div class="col-1-2 min-height bg-grey-md pad-lg bb-bg bb-home04"></div>
		<div class="col-1-2 min-height bg-grey-lt pad-lg col-flex-column bb-bg bb-logo-right">
			...
			<a href="providers.php#form-section" class="link link-flex">Apply Now <i class="fa fa-caret-right"></i></a>
		</div>
	</div>
